const STAKE_CONTRACT_ID = process.env.STAKE_CONTRACT_ID || 'tools.boxcubespace.testnet'
let API_URL_PARAS = process.env.API_URL_PARAS || 'https://api-v2-testnet.paras.id'
